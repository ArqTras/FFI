...
ios_CC=$(shell xcrun --sdk iphoneos --find clang) -arch arm64 -isysroot$(IOS_SDK) -miphoneos-version-min=$(IOS_MIN_VERSION)
ios_CXX=$(shell xcrun --sdk iphoneos --find clang++) -arch arm64 -isysroot$(IOS_SDK) -miphoneos-version-min=$(IOS_MIN_VERSION)
